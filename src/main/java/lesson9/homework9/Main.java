...
3. Написать функцию, принимающую на вход список Student и экземпляр Course, возвращающую список студентов, которые посещают этот курс.
    ...
    public static void main(String[] args) {
        ...
        students.add(new Student("Olga", Arrays.asList(new Course("Biology"),
                new Course("Testing"))));
        students.add(new Student("Vlad", Arrays.asList(new Course("Math"), new Course("Biology"),
                new Course("Testing"))));
        students.add(new Student("Pavel", Arrays.asList(new Course("Math"),
                new Course("Testing"), new Course("Physics"))));
        students.add(new Student("Kristina", Arrays.asList(new Course("Physics"), new Course("Math"),
                new Course("Biology"), new Course("Testing"), new Course("Geography"))));
